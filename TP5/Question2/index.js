...
function displayData() {
  ...
  console.log('b');
  xmlhttp.open("GET","C:/Users/Baptiste/Desktop/ENSSAT/web serv/TP5/Question2/INFO2_G1_TP1.ics",true);
  console.log('c');
  //xmlhttp.send('Access-Control-Allow-Origin=*');//ajoute header
  xmlhttp.send();

  //var iCalendarData = fetch("C:/Users/Baptiste/Desktop/ENSSAT/web serv/TP5/Question2/INFO2_G1_TP1.ics");
